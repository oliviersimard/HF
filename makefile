...
INC=${HOME}/include
LIB=${HOME}/lib
CXXFLAGS= -L$(LIB) -ljson_spirit -lfftw3

PROG=PiTon

all: $(PROG)

$(PROG): $(OBJ)/main.o $(OBJ)/json_utils.o $(OBJ)/fft.o $(OBJ)/param.o $(OBJ)/Hubbard.o
	$(CXX) $(OBJ)/main.o $(OBJ)/json_utils.o $(OBJ)/fft.o $(OBJ)/param.o $(OBJ)/Hubbard.o $(CXXFLAGS) -o main.out
